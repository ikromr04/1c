  ...
  <main class="home-page">
    <article class="welcome-section">
      <div class="container welcome-container">
        <div class="welcome-right">
          <h1 class="welcome-title">{{$home['welcome-title']}}</h1>
          <p class="welcome-subtitle">{{$home['welcome-subtitle']}}</p>
          <a class="link link--yellow welcome-link" href="{{route('services')}}">{{$home['welcome-link']}}</a>
        </div>
    ...
    <section class="whywe-section">
      <div class="container whywe-container">
        <div class="whywe-inner">
          <h2 class="whywe-title">{{$home['whywe-title']}}</h2>
          <ul class="whywe-list">
            <li class="whywe-list-item">
              ...
              <h3 class="whywe-list-title">{{$home['whywe-escort-title']}}</h3>
              <p class="whywe-list-subtitle">{{$home['whywe-escort-subtitle']}}</p>
            </li>
            <li class="whywe-list-item">
              ...
              <h3 class="whywe-list-title">{{$home['whywe-effect-title']}}</h3>
              <p class="whywe-list-subtitle">{{$home['whywe-effect-subtitle']}}</p>
            </li>
            <li class="whywe-list-item">
              <div class="whywe-list-icon">
              ...
              <h3 class="whywe-list-title">{{$home['whywe-client-title']}}</h3>
              <p class="whywe-list-subtitle">{{$home['whywe-client-subtitle']}}</p>
            </li>
          </ul>
          <h2 class="advantages-title">{!! $home['advantages-title'] !!}</h2>
          ...
          <svg width="50" height="50">
            <rect x="0" y="0" width="100%" height="100%" rx="20" stroke-width="2" stroke="#aeaeae" stroke-dasharray="2 8" fill="none" />
          </svg>
        </div>
      </div>
    </section>
    ...
    <section class="products-section">
      <div class="container whywe-container">
        <div class="products-section-inner">
          <h2 class="products-section-title">{{$home['products-section-title']}}</h2>
          <p class="products-section-subtitle">{{$home['products-section-subtitle']}}</p>
        ...
        <form class="feedback-form" action="{{route('feedback')}}" method="post">
          ...
          <div class="feedback-btn-wrap">
            <button class="feedback-form-btn feedback-submit-btn">
              ...
              <span class="text">{{$header['feedback-submit-btn']}}</span>
            </button>
    ...
    <section class="projects-section">
      <div class="container projects-container">
        <h2 class="projects-section-title">{{$home['projects-section-title']}}</h2>
        <p class="projects-section-subtitle">{!! $home['projects-section-subtitle'] !!}</p>
        <ul class="products-list">
