<ul data-list="texts-actions" class="actions-list">
  <li class="actions-item">
    <button data-action="update" class="actions-action" type="button" tabindex="-1">Редактировать</button>
  </li>
</ul>

<ul data-list="buttons-actions" class="actions-list">
  <li class="actions-item">
    <button data-action="update" class="actions-action" type="button" tabindex="-1">Редактировать</button>
  </li>
</ul>

<ul data-list="pages-actions" class="actions-list">
  <li class="actions-item">
    <button data-action="update" class="actions-action" type="button" tabindex="-1">Редактировать</button>
  </li>
  <li class="actions-item">
...
<ul data-list="advantages-actions" class="actions-list">
  <li class="actions-item">
    <button data-action="create" class="actions-action" type="button" tabindex="-1">Добавить</button>
  </li>
  <li class="actions-item">
    <button data-action="update" class="actions-action" type="button" tabindex="-1">Редактировать</button>
  </li>
...
<ul data-list="companies-actions" class="actions-list">
  <li class="actions-item">
    <button data-action="create" class="actions-action" type="button" tabindex="-1">Добавить</button>
  </li>
  <li class="actions-item">
...
<ul data-list="success-steps-actions" class="actions-list">
  <li class="actions-item">
    <button data-action="create" class="actions-action" type="button" tabindex="-1">Добавить</button>
  </li>
  <li class="actions-item">
...
<ul data-list="members-actions" class="actions-list">
  <li class="actions-item">
    <button data-action="create" class="actions-action" type="button" tabindex="-1">Добавить</button>
  </li>
  <li class="actions-item">
...
<ul data-list="certificates-actions" class="actions-list">
  <li class="actions-item">
    <button data-action="create" class="actions-action" type="button" tabindex="-1">Добавить</button>
  </li>
  <li class="actions-item">
